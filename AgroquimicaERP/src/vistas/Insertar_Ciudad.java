 ...
 * @author omar_
 */
public class Insertar_Ciudad extends javax.swing.JFrame {
    ...
    public Insertar_Ciudad(JTable tbl) throws SQLException, IOException {
        initComponents();
        ...
        txtIdCiudad.setText(dao.ciudades.next());
    ...
    private void initComponents() {
        ...
        setTitle("Insertar Ciudad");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel5.setFont(new java.awt.Font("Candara", 1, 36)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Insertar Ciudad");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 11, -1, -1));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(cmbEstados.getItemCount() > 0) {
            ...
            if(!nombre.equals("")) {
                if(dao.ciudades.insert(new Ciudad(nombre, idEstado))) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insertar_Ciudad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Insertar_Ciudad(null).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Insertar_Ciudad.class.getName()).log(Level.SEVERE, null, ex);
