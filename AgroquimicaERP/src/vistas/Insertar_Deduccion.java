 ...
 * @author omar_
 */
public class Insertar_Deduccion extends javax.swing.JFrame {
     ...
     */
    public Insertar_Deduccion(JTable tbl) throws SQLException, IOException {
        initComponents();
        ...
        txtIdDeduccion.setText(dao.deducciones.next());
    }
    ...
    public void nueva() {
        ...
        txtNombre.setText("");
        jTextArea1.setText("");
        jSpinnerPorcentaje.setValue(10);
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Registrar Deducción");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(!nombre.equals("") && !descripcion.equals("")) {
            ...
            if(dao.deducciones.insert(new Deduccion(nombre, descripcion, porc))) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insertar_Deduccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Insertar_Deduccion(null).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Insertar_Deduccion.class.getName()).log(Level.SEVERE, null, ex);
