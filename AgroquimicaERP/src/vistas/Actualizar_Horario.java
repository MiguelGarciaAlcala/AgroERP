            ...
            if(compare(hi, hf) < 0) {
                if(!dias.isEmpty()) {
                    if((hi != null) && (hf != null)) {
                        ...
                        ArrayList <String[]> hrs = dao.horarios.get(idEmp, true, idHorario);
                        ...
                        if(!day_arr.equals(datos[2])) {
                            if(!repeat) {
                                int ans = JOptionPane.showConfirmDialog(null, 
                                    "Se actualizará el horario\n¿Deseas continuar?", "Advertencia", 2);
                            ...
                            JOptionPane.showMessageDialog(null, "Modifique el horario para actualizarlo.", "No hay cambios en el horario", 2);
                    } else
